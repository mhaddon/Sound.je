...
public class FacebookPlace extends DataObject implements Serializable {
    private final String name;

    @JsonProperty("location")
    private final FacebookLocation location;
     ...
     */
    @JsonIgnore
    public Optional<FacebookLocation> getLocation() {
